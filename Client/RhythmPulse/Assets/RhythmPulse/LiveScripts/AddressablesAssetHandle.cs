...
namespace RhythmPulse
{
    ...
    public sealed class AddressablesPackage : IAssetPackage
    {
        ...
        public CycloneGames.AssetManagement.Runtime.IAllAssetsHandle<TAsset> LoadAllAssetsAsync<TAsset>(string location) where TAsset : UnityEngine.Object => throw new NotSupportedException();
        ...
        public CycloneGames.AssetManagement.Runtime.IInstantiateHandle InstantiateAsync(IAssetHandle<GameObject> handle, Transform parent = null, bool worldPositionStays = false, bool setActive = true) => throw new NotSupportedException();
        public CycloneGames.AssetManagement.Runtime.ISceneHandle LoadSceneSync(string sceneLocation, UnityEngine.SceneManagement.LoadSceneMode loadMode = UnityEngine.SceneManagement.LoadSceneMode.Single) => throw new NotSupportedException();
        public CycloneGames.AssetManagement.Runtime.ISceneHandle LoadSceneAsync(string sceneLocation, UnityEngine.SceneManagement.LoadSceneMode loadMode = UnityEngine.SceneManagement.LoadSceneMode.Single, bool activateOnLoad = true, int priority = 100) => throw new NotSupportedException();
        public Task UnloadSceneAsync(CycloneGames.AssetManagement.Runtime.ISceneHandle sceneHandle) => throw new NotSupportedException();
        ...
        public CycloneGames.AssetManagement.Runtime.IDownloader CreateDownloaderForAll(int downloadingMaxNumber, int failedTryAgain, int timeoutSeconds = 60) => null;
        public CycloneGames.AssetManagement.Runtime.IDownloader CreateDownloaderForTags(string[] tags, int downloadingMaxNumber, int failedTryAgain, int timeoutSeconds = 60) => null;
        public CycloneGames.AssetManagement.Runtime.IDownloader CreateDownloaderForLocations(string[] locations, bool recursiveDownload, int downloadingMaxNumber, int failedTryAgain, int timeoutSeconds = 60) => null;
        public Task<CycloneGames.AssetManagement.Runtime.IDownloader> CreatePreDownloaderForAllAsync(string packageVersion, int downloadingMaxNumber, int failedTryAgain, int timeoutSeconds = 60, System.Threading.CancellationToken cancellationToken = default) => Task.FromResult<CycloneGames.AssetManagement.Runtime.IDownloader>(null);
        public Task<CycloneGames.AssetManagement.Runtime.IDownloader> CreatePreDownloaderForTagsAsync(string packageVersion, string[] tags, int downloadingMaxNumber, int failedTryAgain, int timeoutSeconds = 60, System.Threading.CancellationToken cancellationToken = default) => Task.FromResult<CycloneGames.AssetManagement.Runtime.IDownloader>(null);
